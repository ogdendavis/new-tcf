        ...
        <div className="section__container">
          <div className="section contact-us__content">
            ...
            <div className="contact-us__form">
              ...
              <Contact home={this.props.home} id={this.props.formId} addClass={this.props.addClass}/>
            </div>
